...
if (styleElement) {
  ...
  console.log("لا يوجد عنصر <style> في الصفحة.");
}
...
<header class="header" id="header">
      ...
      <nav>
        <ul>
          ...
          <li><a href="who are we.html"> خدماتنا</a></li>
          <li><a href="course.html">سياسة الخصوصية </a><a></a></li><a>
          
          </a><li><a></a><a href="Connect us.html">تواصل معنا</a></li>
        </ul>
      </nav>
      <div class="menu-icon">
      ...
      <nav class="mobil-menue">
        ...
        <ul>
          ...
          <li><a href="course.html">الدورات</a></li>
          <li><a href="Find  teacher.html">اعثر على معلم</a></li>
          <li><a href="Connect us.html">تواصل معنا</a></li>
        </ul>

        <div class="but-login">
          <a href="login in.html">تسجيل الدخول</a>
          <a href="sgin in.html">التسجيل</a>
        </div>
      </nav>
    </header>
...
// إنشاء عنصر جديد للاستبدال
var newFooter = document.createElement("footer");
newFooter.innerHTML = 
`
<link rel="stylesheet" href="../assets/css/fontawesome-free-6.1.0-web/css/all.min.css">
<link rel="stylesheet" href="../../assets/css/fontawesome-free-6.1.0-web/css/all.min.css">
<link rel="stylesheet" href="../../assets/css/fontawesome-free-6.1.0-web/css/all.min.css">
...
<link rel="stylesheet" href="../../assets/css/tool-style.css">
      ...
      <div class="footer">
        <div class="footer-box">
          ...
          <ul>
            <li><a href="who are we.html">من نحن</a></li>
            <li class="footer-li">
              <a href="Protection and security.html">الحماية والامان</a>
            </li>
            <li class="footer-li">
        ...
        <div class="footer-box">
          ...
          <ul>
            ...
            <li class="footer-li"><a href="Connect us.html">تواصل معنا</a></li>
          </ul>
        </div>
        <div class="footer-box-socail">
          <img src="img/WhatsApp Image 2023-02-15 at 04.08.29.png" alt="" srcset="">
          <p>تابعنا على</p>
      ...
      <div class="copy-right">جميع الحقوق محفوظة | | 2023</div>
...
// استخدم الوظيفة querySelector() لتحديد العنصر المناسب
var inputElement = document.querySelector('input[onclick="if (!window.__cfRLUnblockHandlers) return false; window.location=\'https://www.un-web.com/tools/gold_price/\'"]');


// قم بتغيير قيمة الخاصية onclick
inputElement.setAttribute('onclick', 'window.location.href = "../index.html";');
